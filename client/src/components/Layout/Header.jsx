    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          {/* Quick theme switcher (Desktop only) */}
          <button
            onClick={toggleTheme}
            className="hidden md:flex p-2 rounded-xl hover:bg-border-subtle transition-all duration-200 cursor-pointer text-text-secondary hover:text-text-primary"
